...
def parcours_exaustive(graph, first_point):
    """
    ...
    while l_chemin_en_construction:
        l_new_chemin = []
        for chemin in l_chemin_en_construction:
            ...
            elif len(chemin) > len(plus_long_chemin):
                plus_long_chemin = chemin
        

        pbar.n = len(plus_long_chemin)
        pbar.refresh()
        
        l_chemin_en_construction = l_new_chemin
